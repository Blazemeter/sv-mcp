    ...
    @mcp.tool(
        ...
        - create: Create a new virtual service.
            args(VirtualService): A virtual service object with the following fields:
                ...
                harborId (str): Mandatory. The blazemeter location harbor id. If user not specifies location use '5c544422c7dc9735767b23ce'
                shipId (str): Mandatory. The blazemeter location ship id. If user not specifies location use '5d3ccab3526ad28f53205574'
